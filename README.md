...
-  **5.4.x**: [lienol](https://github.com/Lienol/openwrt/tree/master/target/linux/ramips)-适配机型:K2p(公版, 5.10.x), [coolsnowwolf/lede](https://github.com/coolsnowwolf/lede)-适配机型:B70硬改SPI闪存版
## Lienol分支说明
