...
mkdir package/op-luci
git clone -b 18.06 https://github.com/Lienol/openwrt-luci.git package/op-luci
mv package/op-luci/themes/luci-theme-argon-light-mod/ package/feeds/custom/luci-theme-argon/
